class AccessPulseCopy {
  ...
  static const addPlaceTitle = 'Magdagdag ng lugar';
  static const addPlaceSubtitle =
      'Ilagay ang basic info para makita rin ito sa AccessPulse.';
  static const addPlaceSuccess =
      'Nadagdag ang lugar. Wala pa tayong sapat na accessibility info dito.';
  static const saveAndOpenPlace = 'I-save at buksan';
  static const noPlaceFound =
      'Wala sa listahan? Pwede mo itong idagdag para masundan ang accessibility info.';
  static const useThisLocation = 'Gamitin ang lokasyong ito';
  static const chooseLocation = 'Pumili ng lokasyon';
  static const chooseLocationHelp =
      'I-tap ang mapa para ilagay o ilipat ang pin ng lugar.';
  ...
  static const aiGuidance = 'AI guide';
